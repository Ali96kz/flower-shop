...
public class SQLCreator<E extends BaseEntity> {
    ...
    private static final String SET_DELETE_DAY_WHERE_ID = " set deleteDAY = ? where id = ";
    private static final String SQL_WHERE_ID = " where id = ";
    private static final String DECLARED_FIELD_ID = "id";
    private static final String SQL_FROM = " FROM ";
    private static final String PREAPARED_STATEMENT_SET = " SET ";
    ...
    public String createSQLForUpdate(E item) throws DAOException {
        try {
            ...
            logger.error("try to get value from private field", e);
    ...
    public String createSQLForDelete(E item) {
        try {
            ...
            logger.error("can't find field", e);
